export const Footer = () => {
  return (
    <footer className="border-t border-white/10 bg-slate-900/80 backdrop-blur-xl">
      <div className="max-w-6xl mx-auto px-6 py-8 text-sm text-gray-400 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-2">
          <span>© {new Date().getFullYear()} Jerson Q. Conmigo</span>
          <span className="hidden md:inline text-gray-600">·</span>
          <span className="text-gray-500 text-xs">Senior Frontend Engineer</span>
        </div>
